...
public class SingleStackNavigationExampleActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if (mSingleStackNavigationManagerFragmentTag == null) {
            ...
            navManager.setDefaultPresentAnimations(com.dmcapps.navigationfragment.R.anim.slide_in_from_right, com.dmcapps.navigationfragment.R.anim.slide_out_to_left);
            navManager.setDefaultDismissAnimations(com.dmcapps.navigationfragment.R.anim.slide_in_from_left, com.dmcapps.navigationfragment.R.anim.slide_out_to_right);
